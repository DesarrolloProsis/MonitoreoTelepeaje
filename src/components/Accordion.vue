<template>
  <div class="flex justify-between bg-blue-200 container items-center flex-none p-5 rounded-lg h-16 shadow-xl mt-6 transition-opacity duration-500">
    ...
    <div class="flex gap-2">
        <button class="bg-gray-100" @click="mostraracordion()"><ChevronDownIcon class="h-5 w-5 text-blue-500"/></button>
        <button class="bg-green-500" @click="abriraccion()"><PlusSmIcon class="h-5 w-5 text-blue-500"/></button>
    </div>
  </div>
